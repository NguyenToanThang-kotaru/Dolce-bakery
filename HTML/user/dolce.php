            ...
            <form id=login-form-son name="login-form-son" action="../../PHP/users/UserCtrl.php" method="POST">
                ...
                <div class="login-password">
                    ...
                    <div class="password-container">
                        <input type="password" name="lg-password" class="password" id="lg-password"
        ...
        <div id="register-form">
            ...
            <form id="register-form-son" name="register-form-son" action="../../PHP/users/UserCtrl.php" method="POST">
                ...
                <div class="register-username">
                    ...
                    <input type="text" name="rg-username" class="username" placeholder="Username or email address"
                        required><br>
                </div>

                <div class="register-username">
                    <label for="rg-email">Enter your email</label><br>
                    <input type="text" name="rg-email" class="username" placeholder="Username or email address"
                        required><br>
                </div>
                ...
                <div class="show-product" id="product-list">
                    ...
                    <div class="product-container" id="cookie-container">
                        ...
                        <div class="cookie-product">
                            ...
                            <div class="product-name">Kem Cake</div>
                            <div class="product-end">
                                <div class="price">1,200,000 đ</div>
                                <div class="add-cart"><img src="../../assest/cart.png" alt=""></div>
                            </div>
                        </div>
                        <div class="cookie-product">
                        ...
                        <div class="cookie-product">
                            ...
                            <div class="product-name">Kem Cake</div>
                            <div class="product-end">
                                <div class="price">3,000,000 đ</div>
                                <div class="add-cart"><img src="../../assest/cart.png" alt=""></div>
                            </div>
                        </div>
                        <div class="cookie-product">
